...
static const char *fonts[]          = { "Fira Code Nerd Font:pixelsize=10:antialias=true:autohint=true" };
static const char dmenufont[]       = "Fira Code Nerd Font:pixelsize=10:antialias=true:autohint=true";
