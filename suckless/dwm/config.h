...
static const char *fonts[]          = { "RobotoMono Nerd Font:pixelsize=10:antialias=true:autohint=true" };
static const char dmenufont[]       = "RobotoMono Nerd Font:pixelsize=10:antialias=true:autohint=true";
