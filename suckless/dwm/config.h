...
static const char *fonts[]          = { "Fira Code Nerd Font:pixelsize=9:antialias=true:autohint=true" };
static const char dmenufont[]       = "Fira Code Nerd Font:pixelsize=9:antialias=true:autohint=true";
