...
static const char *fonts[]          = { "Noto Mono Nerd Font:pixelsize=10:antialias=true:style=bold:autohint=true" };
static const char dmenufont[]       = "Noto Mono Nerd Font:pixelsize=10:antialias=true:style=bold:autohint=true";
