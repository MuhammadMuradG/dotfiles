...
static const unsigned int snap      = 15;       /* snap pixel; to be have a smooth window dragging this needs to be equal gap */
static const unsigned int gap       = 15;       /* gap pixel between windows and monitor borders */
